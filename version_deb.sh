...
file=plugins/lider-ahenk-$1-plugin/ahenk-$1/debian/changelog
if [[ -f $file ]]; then
...
file=plugins/lider-ahenk-$1-plugin/ahenk-$1/debian/control
if [[ -f $file ]]; then
...
file=plugins/lider-ahenk-$1-plugin/ahenk-$1/$1/main.py
if [[ -f $file ]]; then
	sed -i -e 's/'1.0.0'/'1.1'/g' $file
